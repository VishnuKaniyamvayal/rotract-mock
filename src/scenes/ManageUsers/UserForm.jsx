            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                ...
                >
                  ...
                  <Select
                    value={values.clubId} bloodGroup
                ...
                <FormControl fullWidth variant="filled"
                  sx={{ gridColumn: "span 2" }}
                >
                  <InputLabel>Is Board Member ?*</InputLabel>
                  <Select
                    value={values.isBoardMember} bloodGroup
                    onChange={(event) => { handleChange(event); event.target.value == 0 ? setBoardMember(0) : setBoardMember(1) }}
                    name="isBoardMember"
                    error={!!touched.isBoardMember && !!errors.isBoardMember}
                    helperText={touched.isBoardMember && errors.isBoardMember}
                  >
                ...
                /> */}
                {
                  boardMember ?
                    ...
                    >
                      ...
                      >
                        {/* dynamically print the designation */}
                        <MenuItem value={0} >President</MenuItem>
                        <MenuItem value={1}>vice Secretary</MenuItem>
                        <MenuItem value={2}> Treasurer </MenuItem>
                        <MenuItem value={3}> General Secretary </MenuItem>
                      </Select>
                    </FormControl>
                    :
                    ""
